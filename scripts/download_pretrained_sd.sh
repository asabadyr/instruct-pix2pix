...
curl -L https://huggingface.co/XpucT/Deliberate/resolve/main/Deliberate_v2.safetensors -o $SCRIPT_DIR/../stable_diffusion/models/ldm/stable-diffusion-v1/Deliberate_v2.safetensors
